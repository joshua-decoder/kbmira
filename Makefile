...
forest_rescore_test: mertlib
	$(CC) -o $@ -Wl,--start-group mert/ForestRescoreTest.o libmert_lib.a  -Wl,-Bstatic -lboost_unit_test_framework-mt -lm -llzma -lbz2 -ltcmalloc_minimal -lboost_thread-mt -lboost_system-mt -lz -Wl,-Bdynamic -ldl -lSegFault -lrt -Wl,--end-group -g -pthread

hypergraph_test: mertlib
	$(CC) -o $@ -Wl,--start-group mert/HypergraphTest.o libmert_lib.a  -Wl,-Bstatic -lboost_unit_test_framework-mt -lm -llzma -lbz2 -ltcmalloc_minimal -lboost_thread-mt -lboost_system-mt -lz -Wl,-Bdynamic -ldl -lSegFault -lrt -Wl,--end-group -g -pthread
